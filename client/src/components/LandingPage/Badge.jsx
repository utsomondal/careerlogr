const Badge = () => {
  return (
    <div className="flex items-center gap-1.5 w-fit bg-accent/10 border border-accent/30 rounded-full px-3.5 py-1.5 mt-6 sm:mt-8 mb-6 sm:mb-8 backdrop-blur-sm">
