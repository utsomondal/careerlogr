const OfferCard = () => {
  return (
    <div className="hidden lg:flex absolute -bottom-6 -left-8 bg-dark-800/95 border border-white/8 rounded-xl px-4 py-3.5 backdrop-blur-xl items-center gap-3 shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
